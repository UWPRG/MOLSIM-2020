In your homework, you will perform four simulations on the system I showed in class. For the purpose of practice, you will start from scratch, that is, starting from the PME.pdb file.
